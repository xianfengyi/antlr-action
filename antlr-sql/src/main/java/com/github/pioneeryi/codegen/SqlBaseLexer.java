...
public class SqlBaseLexer extends Lexer {
	...
	public static final int
		...
		SIMPLE_COMMENT=239, BRACKETED_COMMENT=240, WS=241, UNRECOGNIZED=242;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IS", "ISOLATION", "JSON", "JOIN", "LANGUAGE", "LAST", "LATERAL", "LEFT", 
			"LEVEL", "LIKE", "LIMIT", "LOCALTIME", "LOCALTIMESTAMP", "LOGICAL", "MAP", 
			"MATERIALIZED", "MINUTE", "MONTH", "NAME", "NATURAL", "NFC", "NFD", "NFKC", 
